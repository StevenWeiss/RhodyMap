...
public class ServerMediator
{
    ...
    private static final String ECAMPUS_URL = 
            "https://appsaprod.uri.edu:9503/psp/sahrprod_m2/?cmd=login&languageCd=ENG";
    
    private static final String STUDENT_CENTER_URL =
            "https://appsaprod.uri.edu:9503/" +
    ...
    /**
     * Gets the user's class schedule from eCampus given a valid username
     * and password combination.
     * 
     * @param username
     * @param password
     * @param context Android context to reference DataManager
     * @return
     * @throws IOException if an error in the network's connection arises.
     * @throws LoginException if the given username and/or password is invalid.
     */
    public static void getClasses(final String username, final String password, final MapManager m)
    {
     ...
     */
    private static Map<String, String> loginUser(String username, String password) 
            throws IOException, LoginException
    {
        String data = "timezoneOffset=240&userid=" + username + "&pwd=" + password;
        int contentLength = data.length();
        
        Connection connection = Jsoup.connect(ECAMPUS_URL)
                ...
                .header("Referer", "https://appsaprod.uri.edu:9503/psp/sahrprod_m2/?cmd=login")
                .header("Accept-Encoding", "gzip,deflate")
                .header("Accept-Language", "en-US,en;q=0.8")
                .data("timezoneOffset", "240")
     ...
     * @throws IOException
     */
    private static List<Class> getSchedule(Map<String, String> cookies, MapManager m) 
            throws IOException
    {
        ...
        for (int i = 0; i < classes.size(); i += 2) {
            ...
            String[] information = currentCell.select("span").html().split("<br>");
